...
void init_articles(Article *articles)
{
    ...
    articles[1].items[0] = (Item){200, 300, 200};
    ...
    articles[2].items[0] = (Item){600, 800, 80};
    articles[2].items[1] = (Item){500, 500, 120};
    ...
    articles[3].items[0] = (Item){400, 600, 100};
    ...
    articles[4].items[0] = (Item){400, 400, 100};
    articles[4].items[1] = (Item){500, 300, 200};
    articles[4].items[2] = (Item){300, 700, 70};
    ...
    articles[5].items[0] = (Item){300, 300, 150};
    articles[5].items[1] = (Item){450, 600, 100};
    ...
    articles[6].items[0] = (Item){700, 700, 50};
    articles[6].items[1] = (Item){500, 500, 100};
    articles[6].items[2] = (Item){300, 900, 60};
    articles[6].items[3] = (Item){400, 300, 200};
    ...
    articles[7].items[0] = (Item){200, 800, 120};
    articles[7].items[1] = (Item){400, 600, 70};
    ...
    articles[8].items[0] = (Item){600, 600, 100};
    articles[8].items[1] = (Item){900, 300, 60};
